...
policy = {
    ...
    "model_params_path": "~/robotiq_models/robotiq_startsawyer/experiment_state-2019-07-06_23-52-57.json",
    "model_restore_path": "~/robotiq_models/robotiq_startsawyer/start_sawyer/checkpoint_70000/model-280000",

}

config = {
    "experiment_name": "fine_tune_start_sawyer",
    'traj_per_file':128,
    'save_data': True,
