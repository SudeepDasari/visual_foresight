...
INTERP_SKIP = 16
NEUTRAL_JOINT_ANGLES = np.array([-0.9341090320889985, -1.6162021581163115, 1.310454799975384, -1.7173036560011141, 1.5776386480501732, 1.838331624316244, -2.646464042070116])
...
class LatestEEObs:
    ...
    def get_eep(self):
        pose =  self.KukaObj.get_kuka_cartesian_pose().pose
