...
class GripperInterface(object):
    ...
    def set_gripper(self, position, wait=False):
        logging.getLogger('robot_logger').warning('Calling set_gripper on non-existent gripper!')
    ...
    def set_gripper_speed(self, new_speed):
        logging.getLogger('robot_logger').warning('Calling set_gripper_speed on non-existent gripper!')
