...
def save_hdf5(filename, env_obs, policy_out, agent_data, meta_data):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--meta_data_path', type=str, help='where to get metadata json', default='./meta_data.json')
